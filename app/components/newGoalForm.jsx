...
export default function NewGoalForm(props) {
    ...
    const handleClickNext = (e) => {
      e.preventDefault();
      setPageNum((prevPageNum) => prevPageNum = prevPageNum + 1);
    }
  return (
    <form>
      <div className="space-y-12">
        <div className=" border-b border-gray-900/10 pb-12">
          ...
          >
            <h2 className="block text-gray-500"> Step {pageNum} of 9</h2>
          ...
          <div
          ref={page1Ref} 
          className={`border-b border-gray-900/10 pb-12 transition-all duration-500 ${pageNum == 1 ? 'scale-100 visible' : 'scale-0 hidden'}`}>
      ...
      <button
          type="submit"
          onClick={(e) => { e.preventDefault(); setPageNum((prevPageNum) => prevPageNum = prevPageNum - 1)}}
          style={{left: '0%'}}
